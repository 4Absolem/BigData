...
public class Aire {
    ...
    public String toString() {
        return "Aire{" + "Nombre estacion=" + nombreEstacion + ", Fecha de datos=" + fechaDatos + ", Temperatura minima=" + temperaturaMinima +", Hora de Temperatura Minima=" + horaTemperaturaMinima +", Temperatura Maxima=" + temperaturaMaxima +", Hora de Temperatura Maxima=" + horaTemperaturaMaxima + '}';
    }
